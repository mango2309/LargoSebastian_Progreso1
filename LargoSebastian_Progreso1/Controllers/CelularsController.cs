...
namespace LargoSebastian_Progreso1.Controllers
{
    public class CelularsController : Controller
    {
        ...
        public CelularsController(LargoSebastian_Progreso1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCelular,Modelo,Anio,Precio,LargoS")] Celular celular)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCelular,Modelo,Anio,Precio,LargoS")] Celular celular)
        {
